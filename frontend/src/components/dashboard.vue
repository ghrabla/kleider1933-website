<template>
  ...
  <div class="statistic med">
    ...
    <div class="sta-box">
      <div class="sta-img">
        <i class="fa fa-star fa-2x" aria-hidden="true" style="color: green"></i>
      </div>
      <div class="sta-content">
  ...
  <div class="container1">
    ...
    <ul class="responsive-table">
      <li class="table-header">
        <div class="col col-1">
          <i class="fa fa-snowflake-o" aria-hidden="true"></i> Name
        </div>
        <div class="col col-3">
        ...
        <div class="col col-5">
          <i class="fa fa-product-hunt" aria-hidden="true"></i> Gender
        </div>
        <div class="col col-6">
          <i class="fa fa-keyboard-o" aria-hidden="true"></i> Type
        </div>
        <div class="col col-7">
      ...
      <li class="table-row" v-for="product in filteredList" :key="product.id">
        <div style="display: flex; width: 100%; align-items: center">
          ...
          <div class="col col-1" data-label="First name">
            <img v-bind:src="'../img/' + product.image" alt="" class="img-pr" />
          </div>
          <div class="col col-8 action-icon" data-label="Action">
            <a href="javascript:void(0)" @click="getproduct(product.id)">
            ...
            ></a>
            <a href="javascript:void(0)" @click="getproduct(product.id)"
              ><i class="fa-solid fa-info" @click="showModaldet = true"></i
            ></a>
          </div>
        </div>
      </li>
...
export default {
  ...
  methods: {
    ...
    deleteproduct(id) {
      Swal.fire({
        ...
        if (result.value) {
          axios
            .delete(
              "http://localhost/kleider1933-website/backend/API/products/delete.php?id=" +
                id
            )
            .then((response) => {
    ...
    getproduct(id) {
      axios
        .post(
          "http://localhost/kleider1933-website/backend/API/products/read_single.php?id=" +
            id
        )
        .then((response) => {
