  ...
  data() {
    return {
      ...
      admin : {id:'',fullname : '',email : '',password : ''},
       products : [],
       product : {id : '',name : '',price : '',title : '',gender : '',type : '',image : '',fullname:'',phone : '',email:'',city:'',adresse:'',postale:''},
       orders : [],
       order : {},
       keyword:'',
		nodata:false,
       ...
       ,getadmins(){
        ...
        deleteuser(id){
            Swal.fire({
                ...
                if (result.value) {
                    axios.delete('http://localhost/kleider1933-website/backend/API/users/delete.php?id=' + id)
                        .then(response => {
                            Swal.fire(
                                'Deleted !',
                                'success'
         ...
         updateuser() {
            axios.put('http://localhost/kleider1933-website/backend/API/users/update.php', {
        ...
        getuser(id) {
            axios.post('http://localhost/kleider1933-website/backend/API/users/read_single.php?id=' + id)
                .then(response => {
        ...
        clearFields(){
            this.user = {id : '',name : '',price : '',title : '',gender : '',type : '',image : ''};
        }
},
 computed: {
          // displayedusers () {
          ...
          // }
              ...
              filteredList() {
             return this.paginate(this.users.filter( user => user.fullname.toLowerCase().includes(this.keyword)));
    }
      },
      watch: {
          users () {
